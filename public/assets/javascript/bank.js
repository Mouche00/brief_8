...
$(document).ready(function() {
    ...
    let table = $('#table').DataTable({
        ...
        'columns': [
            ...
            { data: 'id',
                render : function(data, type, row) {
                    return '<button class="delete" type="button" data-id=' + data + '><i class="fa-solid fa-trash-can"></i></button></td><td class="border-x-2 border-b-2 border-black"><button class="edit" type="button" data-id=' + data + '><i class="fa-solid fa-pen-nib"></i></button>'
                } 
            },
